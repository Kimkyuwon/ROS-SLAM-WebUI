// Server ports — loaded from /api/server_config (ROS params web_port, pc2_ws_port).
// Defaults match launch/ros_slam_webui.launch (web_port=8880, pc2_ws_port=8881).
...
function getPc2WsPort() {
    return window.ROS_SLAM_WEBUI.pc2WsPort || 8881;
}
